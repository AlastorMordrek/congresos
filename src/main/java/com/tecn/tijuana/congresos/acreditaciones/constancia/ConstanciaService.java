...
public class ConstanciaService {
  ...
  private final ConstanciaRepository consRep;
   ...
   *
   * @param consRep
   * Repositorio de DB de la entidad de CONSTANCIA usado para abstraer consultas
...
//  @Autowired
  ...
  public Boleto inscribirse (
    ...
    var reg = consRep.saveAndFlush(Boleto.nuevo(actor, congreso, actor));
  ...
  public Boleto inscribir (
    ...
    // Crear y guardar el registro nuevo.
    var reg = consRep.saveAndFlush(Boleto.nuevo(actor, congreso, alumno));
  ...
  public Boleto cancelarMio (
    ...
    return consRep.saveAndFlush(boleto.cancelar());
  }
  ...
  public Boleto pagado (
    ...
    // Actualizar, guardar y retornar el registro.
    return consRep.saveAndFlush(boleto.pagadoEstatus(actor, estatus));
  }
  ...
  public Boleto cancelado (
    ...
    // Actualizar, guardar y retornar el registro.
    return consRep.saveAndFlush(boleto.canceladoEstatus(estatus));
  }
  ...
  public Boleto marcar (
    ...
    // Actualizar, guardar y retornar el registro.
    return consRep.saveAndFlush(boleto.marcar());
  }
  ...
  public Boleto estampar (
    ...
    // Actualizar, guardar y retornar el registro.
    return consRep.saveAndFlush(boleto.estampar());
  }
  ...
  public List<Boleto> buscar (String txt, int page, int pageSize) {
    ...
    if (Objects.isNull(txt) || txt.isBlank()) {
      return consRep.findAll(pg).getContent();
    }
   ...
   */
  public Constancia afirmar (
    Long id
  )
    throws ResponseStatusException {

    return consRep.findById(id)
      .orElseThrow(() ->
        new ResponseStatusException(
          HttpStatus.NOT_FOUND,
          String.format("Constancia con ID: %s no encontrada", id)));
  }
  ...
  public Boleto afirmarFolioLargo (
    ...
    return consRep.qFolioLargo(folio)
      .orElseThrow(() ->
        new ResponseStatusException(
          HttpStatus.NOT_FOUND,
   ...
   * {@code HTTP-NOT_FOUND} si no se encuentra el registro.
   */
  public Constancia afirmarIdCongresoNoControlAlumno (
    Long congresoId, String noControl
  )
    throws ResponseStatusException {

    return consRep.qCongresoIdAlumnoNoControl(congresoId, noControl)
      .orElseThrow(() ->
        new ResponseStatusException(
          HttpStatus.NOT_FOUND,
          String.format(
  ...
  public boolean afirmarAlumnoNoInscrito (Long congresoId, Long alumnoId) {
    ...
    var _reg = consRep.qCongresoIdAlumnoId(congresoId, alumnoId)
      .orElse(null);
